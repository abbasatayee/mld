...
const Contact = () => {
  useDocTitle("KSD | Knight Software Development - Send us a message");
            ...
            <div className="flex flex-col text-white">
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-400">Tel: (+93) 781 269 254</p>

                  <div className="mt-5">
                    <h2 className="text-2xl">Send an E-mail</h2>
                    <p className="text-gray-400">info@knightsd.com</p>
                  </div>
                </div>
              </div>

              <div className="flex my-4 w-2/3 lg:w-1/2"></div>
            </div>
          </div>
        </div>
      </div>
